...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form action="{{ route('produk.update', $edit->id) }}" method="post" class="form-horizontal">
                @method('put')
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <!-- <div class="form-group col-md-12">
                            ...
                            <input type="text" name="kode_produk" value="{{ old('kode_produk') }}" class="form-control @error('kode_produk') is-invalid @enderror" placeholder="Masukkan Kode Produk">
                            @error('kode_produk')
